...
def train_laom(config: LAOMConfig):
    ...
    for epoch in trange(config.num_epochs, desc="Epochs"):
        ...
        for i, batch in enumerate(dataloader):
            ...
            writer.add_scalar("lapo/total_loss", loss.item(), total_iterations)
            writer.add_scalar("lapo/mse_loss", loss0.item(), total_iterations)
            writer.add_scalar("lapo/true_action_mse_loss", loss1.item(), total_iterations)
        ...
        if config.eval_data_path is not None:
            ...
            writer.add_scalar("lapo/eval_true_action_mse_loss", eval_mse_loss, total_iterations)
